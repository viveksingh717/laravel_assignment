        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{url('company_store/')}}" method="POST" class="p-3" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="logo" id="logoFile" onchange="$('.preview__image')[0].src = window.URL.createObjectURL(this.files[0])">
